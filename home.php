...
<body>
    <div class="site">
        ...
        <main>
            <section aria-label="Recomendaciones de compra">
                <div class="carousel" data-carousel>
                    <button class="carousel-button prev" data-carousel-button="prev">&#8656;</button>
                    <button class="carousel-button next" data-carousel-button="next">&#8658;</button>
                    <ul data-slides>
                        <li class="slide" data-active>
                            <img src="https://images.pexels.com/photos/2693561/pexels-photo-2693561.jpeg"
                                alt="Recomendación 1" />
                        </li>
                        <li class="slide">
                            <img src="https://images.pexels.com/photos/54632/cat-animal-eyes-grey-54632.jpeg"
                                alt="Recomendación 2" />
                        </li>
                        <li class="slide">
                            <img src="https://images.pexels.com/photos/5733423/pexels-photo-5733423.jpeg"
                                alt="Recomendación 3" />
                        </li>
                    </ul>
                </div>
            ...
            <section id="productosTendencia">
                <h1 class="text-center mb-1 mt-4">Productos en tendencia</h1>
                            ...
                            <div class="col">
                                <div class="card shadow-sm h-100">
                                    ...
                                    <div class="card-body d-flex flex-column">
                                        ...
                                        <p class="card-text">
                                            Nutritivo alimento balanceado para todas las razas.
                                        </p>
                                        <div class="mt-auto">
                            ...
                            <div class="col">
                                <div class="card shadow-sm h-100">
                                    ...
                                    <div class="card-body d-flex flex-column">
                                        ...
                                        <p class="card-text">
                                            Cama para mascotas, con juguete interactivo.
                                        </p>
                                        <div class="mt-auto">
                                            <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="col">
                                <div class="card shadow-sm h-100">
                                    <img src="https://www.todomascotascr.com/17345-large_default/correa-con-soporte-y-pop-bag-para-perros-medianos-y-grandes.jpg"
                                        class="card-img-top" alt="Arnes y correa para perro"
                                        style="height: 200px; object-fit: cover" />
                                    <div class="card-body d-flex flex-column">
